...
import {AiOutlineTwitter, AiOutlineFacebook, AiOutlineLinkedin,
} from "react-icons/ai";
...
export default function Hero() {
  const config = {
    ...
    social: {
      twitter: 'https://x.com/sriram777k',
      facebook: 'https://www.facebook.com/profile.php?id=61550038809905',
      linkedin: 'https://www.linkedin.com/in/sriram-777-k',
    } 
  }
  ...
  return  <section className="flex flex-col md:flex-row px-5 py-32 bg-secondary justify-center">
      <div className="md:w-1/2 flex flex-col">
        <h1 className="text-white text-6xl font-hero-font">Hi,<br /> I'm <span className="text-black"> Sriram</span> K
